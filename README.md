...
This repository contains a minimal REPL shell implementation entry point in
`src/main.cpp` and the build tooling to compile and run it locally.
...
```sh
git clone https://github.com/Shriya1181/codecrafters-shell-cpp.git
...
```sh
git clone git@github.com:Shriya1181/codecrafters-shell-cpp.git
cd codecrafters-shell-cpp
```
